...
bool Application::init_input()
{
    ...
    inputs.bind_key(input::EKeyContext::ScenarioScene, SDL_SCANCODE_W, input::Action::MoveUp);
    inputs.bind_key(input::EKeyContext::ScenarioScene, SDL_SCANCODE_A, input::Action::MoveLeft);
    inputs.bind_key(input::EKeyContext::ScenarioScene, SDL_SCANCODE_S, input::Action::MoveDown);
    inputs.bind_key(input::EKeyContext::ScenarioScene, SDL_SCANCODE_D, input::Action::MoveRight);

    inputs.bind_key(input::EKeyContext::ScenarioScene, SDL_SCANCODE_Q, input::Action::ZoomIn);
    inputs.bind_key(input::EKeyContext::ScenarioScene, SDL_SCANCODE_E, input::Action::ZoomOut);

    inputs.bind_btn(input::EKeyContext::ScenarioScene, input::Mouse::WheelUp, input::Action::ZoomIn);
    inputs.bind_btn(input::EKeyContext::ScenarioScene, input::Mouse::WheelDown, input::Action::ZoomOut);

    /** Likewise with actions */
    inputs.bind_action(input::EKeyContext::ScenarioScene, input::Action::MoveUp, [](float dt) {
        gfx::get_renderer().move_camera(glm::vec3(0.f, 1.f, 0.f) * dt * 200.f);
    });
    inputs.bind_action(input::EKeyContext::ScenarioScene, input::Action::MoveLeft, [](float dt) {
        gfx::get_renderer().move_camera(glm::vec3(-1.f, 0.f, 0.f) * dt * 200.f);
    });
    inputs.bind_action(input::EKeyContext::ScenarioScene, input::Action::MoveDown, [](float dt) {
        gfx::get_renderer().move_camera(glm::vec3(0.f, -1.f, 0.f) * dt * 200.f);
    });
    inputs.bind_action(input::EKeyContext::ScenarioScene, input::Action::MoveRight, [](float dt) {
        gfx::get_renderer().move_camera(glm::vec3(1.f, 0.f, 0.f) * dt * 200.f);
    });
    inputs.bind_action(input::EKeyContext::ScenarioScene, input::Action::ZoomIn, [] {
        gfx::get_renderer().move_camera({0.f, 0.f, -.05f});
    });
    inputs.bind_action(input::EKeyContext::ScenarioScene, input::Action::ZoomOut, [] {
        gfx::get_renderer().move_camera({0.f, 0.f, .05f});
    });
