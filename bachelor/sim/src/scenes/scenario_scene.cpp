...
void ScenarioScene::on_enter()
{
    ...
    m_active_systems.emplace_back(new system::Need({&m_registry, &m_dispatcher, &m_rng}));
    m_active_systems.emplace_back(new system::Mitigation({&m_registry, &m_dispatcher, &m_rng}));
    m_active_systems.emplace_back(new system::Action({&m_registry, &m_dispatcher, &m_rng}));
    m_active_systems.emplace_back(new system::Requirement({&m_registry, &m_dispatcher, &m_rng}));
    m_active_systems.emplace_back(new system::Timer({&m_registry, &m_dispatcher, &m_rng}));
    m_active_systems.emplace_back(new system::AI({&m_registry, &m_dispatcher, &m_rng}));
    m_active_systems.emplace_back(new system::Movement({&m_registry, &m_dispatcher, &m_rng}));
    m_active_systems.emplace_back(new system::Rendering({&m_registry, &m_dispatcher, &m_rng}));
}
