...
* When the action is done, the system then runs a check to see if the action succeeds, and then removes it from the list of actions
* Once the strategy is out of actions, if the need has not yet been fullfilled, the next action is chosen
*/
