 ...
 * action has been completed a certain number of times The Timer can take any action on the entity that only requires the registry
 * and entity itself to be properly run It also has functionality to keep running indefinitely
 */
